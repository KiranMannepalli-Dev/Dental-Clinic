    ...
    return (
      ...
      <div className="p-3 border-t border-slate-200 dark:border-slate-900 shrink-0">
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 w-full text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-slate-100 dark:hover:bg-blue-550/10 rounded-lg text-sm font-medium transition-colors cursor-pointer"
        >
