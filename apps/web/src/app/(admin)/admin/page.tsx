...
const DEPARTMENTS = [
  ...
  },
  {
    ...
    description: "View your daily schedule, patient records, clinical notes, reviews, and doctor-specific analytics.",
    icon: Stethoscope,
    ...
    features: ["My Schedule Today", "Patient Records", "Blog & Content", "Patient Reviews", "Performance Reports"],
    redirectTo: "/admin/dashboard",
