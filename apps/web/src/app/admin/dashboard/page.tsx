    ...
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-64 bg-slate-900 text-white flex flex-col shrink-0">
        ...
        <div className="p-4 flex-grow">
          <nav className="space-y-1">
            <a href="#" className="flex items-center gap-3 px-4 py-3 bg-blue-600/10 text-blue-400 rounded-md font-medium">
              <Activity className="w-5 h-5" /> Dashboard
            </a>
            <a href="#" className="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-slate-200 hover:bg-slate-800 rounded-md font-medium transition-colors">
        ...
        <div className="p-4 border-t border-slate-800">
          <button onClick={handleLogout} className="flex items-center gap-3 px-4 py-3 w-full text-slate-400 hover:text-red-400 hover:bg-red-400/10 rounded-md font-medium transition-colors">
      ...
      <div className="flex-grow flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 shrink-0 z-10">
          <h1 className="font-semibold text-xl text-slate-800">Overview</h1>
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-md bg-slate-100 flex items-center justify-center border border-slate-200">
              <span className="font-semibold text-slate-600">AD</span>
            </div>
          </div>
        </header>
