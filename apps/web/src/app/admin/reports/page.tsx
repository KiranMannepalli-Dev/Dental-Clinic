...
export default function ReportsPage() {
  ...
  const kpiCards = [
    ...
    { label: "This Month Revenue", value: stats ? `₹${stats.thisMonthRevenue.toLocaleString("en-IN")}` : "—", icon: DollarSign, color: "from-emerald-500 to-teal-600", sub: `${stats?.completedThisMonth || 0} completed visits` },
